...
import { viewMyEmployeeApi } from "../../Api/Employee";
  ...
  return (
    <div className="Mainpage_Container">
      <div className="Mainpage_Container__inner">
        <header>
          <Link to={`/add-employee`} className="addEmployee_Button">
            Add employee
          </Link>
        </header>
          ...
          <tbody>
            {apiData.map((apiData, index) => (
              <tr key={index}>
                ...
                <td>
                  <Link to={`/view-edit-employee/${apiData._id}`}>
                    View / Edit
                  </Link>
                </td>
              </tr>
